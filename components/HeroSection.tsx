...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      aria-label="Hero"
    >
      <div className="max-w-[1200px] mx-auto grid grid-cols-12 gap-x-10 gap-y-10 items-center min-h-[528px]">
        {/* Left: Text content */}
        ...
        {/* Right: Visual */}
        <div className="hidden lg:flex col-span-4 items-center justify-center animate-on-scroll stagger-3">
          <div className="relative w-full aspect-square max-w-[380px]">
            <Image
              src="/group-1.png"
              alt="Clysto growth studio visual"
              fill
